...
registry.add({
  ...
  handler: async (args) => {
    try {
      ...
      let query = "SELECT id, name, type, description, source FROM kg_entities";
...
registry.add({
  ...
  handler: async (args) => {
    try {
      ...
      return { success: true, data: { entity, relationships } };
    } catch (err) {
      return { success: false, error: (err as Error).message };
    }
  },
...
registry.add({
  ...
  handler: async (args) => {
    try {
      ...
      return { success: true, data: results, depth, startEntity: entityName };
    } catch (err) {
      return { success: false, error: (err as Error).message };
    }
  },
