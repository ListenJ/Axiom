...
import type { ChatMessage } from "../router/provider-caller.js";
...
export function injectConstraints(messages: ChatMessage[], words: string): ChatMessage[] {
 ...
 */
export function autoInjectDreConstraints(
  messages: ChatMessage[],
  extraContext = "",
...
export function buildMessagesWithConstraints(userText: string): { messages: ChatMessage[]; injected: string[] } {
