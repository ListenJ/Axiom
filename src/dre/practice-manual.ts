...
export const PRACTICE_ENTRIES: PracticeEntry[] = [
  {
    ...
    keywords: ["sqlite", "sqlite_busy", "database is locked", "并发写", "数据库锁"],
    constraint:
  ...
  },
  {
    ...
    keywords: ["单元测试", "github.com", "测试超时", "网络测试", "mock fetch", "test timeout", "zhipu 429"],
    constraint:
  ...
  },
  {
    ...
    keywords: ["flaky", "cross-talk", "hallucination", "随机种子", "概率测试", "随机失败"],
    constraint:
  ...
  },
  {
    ...
    keywords: ["bun test", "dist/", "编译测试", "stale test", "误匹配"],
    constraint:
  ...
  },
  {
    ...
    keywords: ["parallel=8", "并行 worker", "模块加载竞态", "is an instance of Promise", "worker 竞态"],
    constraint:
  ...
  },
  {
    ...
    keywords: ["xdg-open", "cmd /c start", "跨平台命令", "linux 打开", "windows 打开", "open 命令"],
    constraint:
  ...
  },
  {
    ...
    keywords: ["没有视觉模型", "无视觉模型", "vision model missing", "没有视觉"],
    constraint:
