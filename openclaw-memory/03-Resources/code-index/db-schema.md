...
exports: ["conversations", "tasks", "knowledge", "entities", "relationships", "modelUsage", "freeModels", "crawlResults", "searchHistory"]
...
| 类型 | 名称 | 行号 |
|------|------|------|
| variable | `conversations` | 9 |
| variable | `tasks` | 23 |
| variable | `knowledge` | 46 |
| variable | `entities` | 66 |
| variable | `relationships` | 75 |
| variable | `modelUsage` | 85 |
| variable | `freeModels` | 102 |
| variable | `crawlResults` | 114 |
| variable | `searchHistory` | 142 |
