---
id: code-crawl.search-engines
type: code-index
source: crawl\search-engines.ts
lang: typescript
created: 2026-05-25
updated: 2026-05-25
word_count: 1487
tags: [code, auto-indexed]
exports: ["SearchEngineResult", "SearchOptions", "SearchAggregator", "searchAggregator"]
imports: ["anti-fingerprint.js", "proxy-manager.js"]
---
...
- **源文件**: `crawl\search-engines.ts`
- **模块**: `crawl.search-engines`
- **行数**: 499
- **索引时间**: 2026-05-25T05:11:12.528Z
...
| 类型 | 名称 | 行号 |
|------|------|------|
| interface | `SearchEngineResult` | 10 |
| interface | `SearchOptions` | 22 |
| class | `SearchAggregator` | 389 |
| variable | `searchAggregator` | 498 |
