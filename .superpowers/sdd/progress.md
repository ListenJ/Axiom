...
Task R1 (test hygiene, 9 files): complete — 76 pass / 7 gated skip / 0 fail, tsc clean; fake-test patterns (catch{expect(true)}, tautologies, self-literal asserts, empty shell) eliminated
