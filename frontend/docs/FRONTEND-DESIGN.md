...
- **材质**：`.overlay-glass`（暗 rgba(22,22,22,.36) / 亮 rgba(255,255,255,.36)，**`blur(56px) saturate(1.6)` 高磨砂**）——低透光 + 高磨砂，玻璃感与可读性兼得；**无丝绸衬底**；深投影分隔（无边框）。
...
- `.overlay-glass`：**`blur(56px) saturate(1.6)` 高磨砂**，背景暗 rgba(22,22,22,.36) / 亮 rgba(255,255,255,.36)（低透光、文字更清晰，仍透出背景光效）；移动抽屉保留 `box-shadow: 0 28px 80px rgba(0,0,0,.78)` + 顶部柔光。
